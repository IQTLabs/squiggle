...
squiggle ../../example_seqs/ecol.heg.fasta ../../example_seqs/banth1.heg.fasta -d 650 325 -o file_mode.html --skip -s 25
squiggle ../../example_seqs/human_HBB.fasta ../../example_seqs/norway_rat_HBB.fasta -d 650 325 -o hbb_comparison.html
